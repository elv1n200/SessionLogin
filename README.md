...
<p>
  <img alt="release"   src="https://img.shields.io/badge/release-v1.3.1-blue">
...
- **Import from launchers** — pulls accounts directly out of the
  official Minecraft Launcher's `launcher_accounts.json` and the
  Modrinth App's bundled SQLite database (`minecraft_users` table),
  in one click.
...
3. Download `sessionlogin-1.3.1.jar` from the
